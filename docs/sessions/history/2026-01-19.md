...
- **legacy PR #76**: Use `NEXT_PUBLIC_FIREBASE_ENV` for Firebase config detection
...
- **legacy PR #77**: Add dev site to CORS allowed origins
...
### Product/Artist Integration (legacy PR #75)
...
| PR | Title |
|----|-------|
| legacy #75 | Product/artist integration (dropdown + display) |
| legacy #76 | Use NEXT_PUBLIC_FIREBASE_ENV for config detection |
| legacy #77 | Add dev site to CORS allowed origins |
| legacy #78 | Update dev environment setup documentation |
