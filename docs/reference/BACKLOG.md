...
### Operations
- [ ] Book directly from an Openings slot (legacy #687 shipped read-only): add a student-picker + prefill the schedule dialog with the block/weekday/time so "Book this slot" needs no separate student-page trip
- [ ] Staff scheduling
