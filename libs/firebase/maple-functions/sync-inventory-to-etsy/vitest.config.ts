...
export default defineConfig({
  root: __dirname,
  test: {
    name: 'firebase-maple-functions-sync-inventory-to-etsy',
    globals: true,
    environment: 'node',
    include: ['src/**/*.spec.ts'],
    coverage: {
      ...
      reportsDirectory:
        '../../../../coverage/libs/firebase/maple-functions/sync-inventory-to-etsy',
      include: ['src/**/*.ts'],
  ...
  resolve: {
    alias: {
      ...
      '@maple/firebase/etsy': resolve(
        __dirname,
        '../../../firebase/etsy/src/index.ts'
      ),
