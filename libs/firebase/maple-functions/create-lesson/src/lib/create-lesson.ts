...
>(
  async (data, context) => {
    ...
    // Block attribution (legacy #686), with the legacy #835 escape hatches: the caller may
    ...
    // Two things cannot be in the room at once (legacy #841). Checked against
    ...
    // this lesson. See legacy #283 payout tracking.
