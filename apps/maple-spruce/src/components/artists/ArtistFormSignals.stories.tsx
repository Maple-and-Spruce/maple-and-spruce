...
import { ArtistFormSignals } from './ArtistFormSignals';
import { mockArtist } from '../../../.storybook/fixtures';

const meta = {
  component: ArtistFormSignals,
  title: 'Artists/ArtistFormSignals',
  parameters: {
    layout: 'centered',
...
} satisfies Meta<typeof ArtistFormSignals>;
...
export default meta;
type Story = StoryObj<typeof ArtistFormSignals>;
