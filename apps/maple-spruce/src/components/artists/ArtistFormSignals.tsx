...
/**
 * ArtistFormSignals - Signals-based Artist Form
 *
 * Migrated from ArtistForm.tsx to use Preact Signals for state management.
 * This provides:
...
interface ArtistFormSignalsProps {
  open: boolean;
  onClose: () => void;
...
export function ArtistFormSignals({
  open,
  onClose,
  onSubmit,
  artist,
  isSubmitting = false,
}: ArtistFormSignalsProps) {
